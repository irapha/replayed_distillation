...
cv2.imwrite('viz/MEANS_{}.png'.format(dat[:-4]), 255*reshape_to_row(np.array(re_means), 32))
...
cv2.imwrite('viz/RAND_{}.png'.format(dat[:-4]), 255*reshape_to_row(np.array(re_random), 32))
