...
def create_model(inp, out_size, temp=1.0):
    with tf.variable_scope('lenet-5'):
        with tf.variable_scope('conv1'):
            ...
            conv1_w = tf.Variable(tf.truncated_normal([5,5,1,6]), name='conv1_w')
        ...
        with tf.variable_scope('fc1'):
            ...
            fc1_w = tf.Variable(tf.truncated_normal(shape=(400,120), name='fc1_w'))
        ...
        with tf.variable_scope('fc2'):
            ...
            fc2_w = tf.Variable(tf.truncated_normal(shape=(120,84), name='fc2_w'))
        ...
        with tf.variable_scope('fc3'):
            ...
            fc3_w = tf.Variable(tf.truncated_normal(shape=(84,10), name='fc3_w'))
