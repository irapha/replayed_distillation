...
def run(sess, f, data, placeholders, train_step, summary_op, summary_op_evaldistill):
    ...
    with sess.as_default():
        ...
        if load_procedure == 'load':
            ...
            data_optimized = np.load('data_optimized_{}.npy'.format(f.experiment))[()]
            ...
            np.save('data_optimized_{}.npy'.format(f.experiment), data_optimized)
        ...
        np.save('activation_stats_{}.npy'.format(f.experiment), all_stats)
        print('stats_saved')
